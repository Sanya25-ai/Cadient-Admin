...
export default function LocationSearchDetailsPage() {
  ...
  const renderLocationNode = (node: LocationNode, level: number = 0): JSX.Element => {
    ...
    const isSelected = node.id === 'atlanta' // Simulate selected location
          ...
          <div className="flex-1">
            ...
            <div className="bg-white border border-gray-300 rounded-lg p-6">
              ...
              <div className="mt-6 pt-4 border-t border-gray-200 flex gap-4">
                ...
                <Button 
                  onClick={() => router.push('/admin-console/locations/search')}
                  variant="outline"
                >
