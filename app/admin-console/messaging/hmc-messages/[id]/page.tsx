...
// Sample data for the existing message
const sampleMessageData = {
  messageTitle: "New Manager Training",
  messageContent: "Lunch and Learn for managers is being offered on Nov 1st at 12:00 EST",
...
export default function EditHMCMessagePage({ params }: { params: { id: string } }) {
  ...
  useEffect(() => {
    ...
    setMessageTitle(sampleMessageData.messageTitle)
    setMessageContent(sampleMessageData.messageContent)
    setStartDate(sampleMessageData.startDate)
    setEndDate(sampleMessageData.endDate)
    setSelectedRoles(sampleMessageData.selectedRoles)
  }, [])
  ...
  const handleSave = () => {
    // Here you would typically save the updated message
    console.log({
      messageTitle,
      messageContent,
      startDate,
  ...
  return (
    <div className="flex-1 bg-white">
      <div className="max-w-7xl mx-auto p-8 pt-6">
        ...
        <div className="fixed right-4 top-1/2 transform -translate-y-1/2 bg-gray-800 text-white p-4 rounded-lg shadow-lg w-64">
          ...
          <div className="space-y-2">
            <div className="text-xs">
              <span className="font-medium">Language Versions</span>
            </div>
            <div className="flex items-center justify-between bg-orange-500 text-white px-2 py-1 rounded text-xs">
              <span>English (US)</span>
              <span className="bg-white text-orange-500 px-1 rounded">1</span>
            </div>
            <div className="flex items-center justify-between bg-gray-600 px-2 py-1 rounded text-xs">
              <span>English</span>
            </div>
            <div className="flex items-center justify-between bg-gray-600 px-2 py-1 rounded text-xs">
              <span>Español</span>
              <span className="bg-orange-500 text-white px-1 rounded">1</span>
            </div>
            <div className="flex items-center justify-between bg-gray-600 px-2 py-1 rounded text-xs">
              <span>Français</span>
              <span className="bg-orange-500 text-white px-1 rounded">1</span>
