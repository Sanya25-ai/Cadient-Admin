...
export default function NewHirePacketPage() {
  const [showChangesModal, setShowChangesModal] = useState(false)
  const [isDraft, setIsDraft] = useState(true) // Starting in draft mode as shown in screenshot
  ...
  return (
    <div className="min-h-screen bg-gray-100">
      ...
      <div className="p-6">
        ...
        {/* Manage New Hire Documents List Section */}
        <div className="space-y-6">
          <div className="border-b border-gray-300 pb-2">
            <h1 className="text-2xl font-semibold text-gray-900">Manage New Hire Documents List</h1>
          </div>

          <p className="text-gray-700">
            Manage documents within your New Hire Packet Documents list. Add new documents from the list of active documents. Remove documents or reorder the list.
          </p>
              ...
              <div>
                ...
                {isDraft && (
                  <div className="mt-4 space-y-2 text-sm text-gray-600">
                    <div className="flex items-center justify-between">
                      <span>📄 Draft created by <strong>MMOSER_DEMO</strong> on Dec 29, 2022 (1:41 AM)</span>
                      <button 
                ...
                <div className="mt-2 space-y-2 text-sm text-gray-600">
                  <div className="flex items-center justify-between">
                    <span>📄 Published by <strong>ADMIN</strong> on Mar 11, 2015 (7:58 AM)</span>
                    <button 
                      onClick={() => setShowChangesModal(true)}
                      className="text-red-500 hover:text-red-600 text-sm font-medium"
                    >
          ...
          <div className="grid grid-cols-2 gap-8 mt-8">
            ...
            {/* New Hire Packet Column */}
            <div>
              <h3 className="text-lg font-semibold text-gray-900 mb-4">New Hire Packet</h3>
              <div className="border border-gray-300 rounded">
                {newHirePacket.map((doc, index) => (
                  <div key={doc} className={`p-4 border-b border-gray-200 last:border-b-0 flex items-center gap-3 ${index % 2 === 0 ? 'bg-white' : 'bg-gray-50'}`}>
                    <div className="w-8 h-8 bg-red-100 border border-red-300 rounded flex items-center justify-center flex-shrink-0">
