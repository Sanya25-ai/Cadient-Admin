...
export default function SalesDemoRetailOmegaNewEmployeeOnboardingPage() {
    ...
    <div className="min-h-screen bg-gray-100">
      ...
      <div className="p-6">
        ...
        <div className="space-y-6">
          ...
          <div>
            <h2 className="text-lg font-semibold text-gray-900 mb-4">Sales Demo Retail Omega New Employee Onboarding</h2>
            ...
            <div className="flex items-center justify-between">
              <div className="w-full">
                ...
                <div className="space-y-2 text-sm text-gray-600">
                  <div className="flex items-center justify-between">
                    <span>📄 Published by <strong>TEST_ADMIN</strong> on Apr 6, 2022 (5:10 AM)</span>
                    <button 
                  ...
                  <div className="flex items-center justify-between">
                    <span>📄 Published by <strong>SHIRLEY.RECRUITER@GMAIL.COM</strong> on Feb 3, 2021 (5:58 PM)</span>
                    <button 
                      onClick={() => setShowChangesModal(true)}
                      className="text-red-500 hover:text-red-600 text-sm font-medium"
                    >
                  ...
                  <div className="flex items-center justify-between">
                    <span>📄 Published by <strong>SHIRLEY.RECRUITER@GMAIL.COM</strong> on Feb 3, 2021 (6:13 AM)</span>
                    <button 
                      onClick={() => setShowChangesModal(true)}
                      className="text-red-500 hover:text-red-600 text-sm font-medium"
                    >
                  ...
                  <div className="flex items-center justify-between">
                    <span>📄 Published by <strong>SHIRLEY.RECRUITER@GMAIL.COM</strong> on Dec 29, 2020 (2:00 AM)</span>
                    <button 
                      onClick={() => setShowChangesModal(true)}
                      className="text-red-500 hover:text-red-600 text-sm font-medium"
                    >
